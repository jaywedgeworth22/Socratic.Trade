...
> **2026-08-25 CURSOR — AppUpdatePromptTests pbxproj leftover (`cursor/app-update-prompt-pbxproj-ddca`).**  #3102 squash `df75ca6f` omitted generated `AppUpdatePromptTests.swift` refs.  Commit the hosted `ios-build` artifact so TestFlight (no xcodegen) stays in sync.  Do not `--force-ship`.  Rollout: `docs/rollouts/2026-08-25-app-update-prompt-pbxproj.md`.
