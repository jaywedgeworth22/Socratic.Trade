...
In progress on `codex/model-catalog-account-labels` (board `0d775009`).  Latest provider catalog and MiniMax API support; single-line account selector and concise paper banner.  PR #3196 remains draft.  Browser component QA passed on desktop/mobile; hosted lint passed, and the Anthropic-path typecheck error is corrected for the next run.  Local lint/typecheck were stopped under severe shared-Mac load.  Rollout: `docs/rollouts/2026-09-09-model-catalog-account-labels.md`.
