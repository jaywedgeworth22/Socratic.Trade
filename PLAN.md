...
> **2026-08-18 CURSOR — iOS UX owner cut (`cursor/ios-ux-owner-cut-bdae`, #2825).** Live Guardrails screenshot: hide taxable wash-sale guard/handling on Roth; never show `__rotate__`; edit binding % NAV and Ask-First ↔ Autopilot on the phone.  Same PR.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
> **2026-08-18 CURSOR — iOS UX owner cut (`cursor/ios-ux-owner-cut-bdae`, #2825).** Live Guardrails screenshot: hide taxable wash-sale guard/handling on Roth; show “Rotate models” instead of `__rotate__`; edit binding % NAV and Ask-First ↔ Autopilot on the phone.  Same PR.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
> **2026-08-18 CURSOR — iOS UX owner cut (`cursor/ios-ux-owner-cut-bdae`, #2825).** Live Guardrails screenshot: hide taxable wash-sale guard/handling on Roth; show “rotate models” instead of `__rotate__`; edit binding % NAV and Ask-First ↔ Autopilot on the phone.  Same PR.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
> **2026-08-18 CURSOR — iOS UX owner cut (`cursor/ios-ux-owner-cut-bdae`, #2825).** Live Guardrails screenshot: hide taxable wash-sale guard/handling on Roth; show “rotate models” instead of `__rotate__`; sweep all user-facing iOS developer/API copy; edit binding % NAV and Ask-First ↔ Autopilot on the phone.  Same PR.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
