...
> **2026-08-25 CURSOR — Console honesty: Discard / approve typed-confirm / Coach chips (`cursor/console-discard-approve-chips-1ffb`).**  Three console bugs, one PR.  Discard clears `universeDraft`.  Approve mirrors `row.executionMode ?? currentMode` and renders 409 `expectedText`.  Home does not toast Approved on `busy`.  Coach chips prefill the note.  No Designer redesign.  No RAG/Pinecone/Datadog.  Keep out of #3090 and #3077.  Rollout: `docs/rollouts/2026-08-25-console-discard-approve-chips.md`.
> **2026-08-25 CURSOR — Console honesty: Discard / approve typed-confirm / Coach chips + leftover UX (`cursor/console-discard-approve-chips-1ffb`).**  Same PR #3093.  Discard clears `universeDraft`.  Approve mirrors `row.executionMode ?? currentMode` and renders 409 `expectedText`.  Home does not toast Approved on `busy`.  Coach chips prefill the note.  Leftover: iOS Open Guardrails tab, Open Connections copy, Tradier (paper).  No Designer redesign.  No RAG/Pinecone/Datadog.  Keep out of #3090 and #3077.  Rollout: `docs/rollouts/2026-08-25-console-discard-approve-chips.md`.
> **2026-08-25 CURSOR — Console honesty + leftover UX (`cursor/console-discard-approve-chips-1ffb`, PR #3093).**  Rebased onto `origin/main` `46865940` (#3096 docs).  Discard / approve typed-confirm / Coach chips plus iOS Open Guardrails, Open Connections copy, Tradier (paper).  Stay off Datadog #3094.  No Desk/IRA rewrite.  Rollout: `docs/rollouts/2026-08-25-console-discard-approve-chips.md`.
