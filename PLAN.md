...
> **2026-08-25 CURSOR — Playwright smoke dismiss ConsentGate (`cursor/smoke-dismiss-consent-0e2b`).**  #3097 Scan-via-More still red: first-use legal overlay intercepts `More`.  Accept if shown, then the existing More vs rail Scan asserts.  Rollout: `docs/rollouts/2026-08-25-smoke-dismiss-consent.md`.
> **2026-08-25 CURSOR — Playwright mobile Scan/More smoke (`cursor/mobile-smoke-scan-more-0e2b`, #3097 `c2ed2c85`).**  `getByText("Scan").first()` matched the hidden desktop rail on iPhone.  Open More on mobile; rail link on desktop.  Overlay leftover is the consent-dismiss follow-up.  Rollout: `docs/rollouts/2026-08-25-mobile-smoke-scan-more.md`.
