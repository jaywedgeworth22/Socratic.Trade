...
> **2026-08-22 CURSOR — Transparent ST favicon + future Android mark (`cursor/st-transparent-favicon-android-4f1a`).**  Website and Android use `graphics/st-mark-transparent.png` (RGBA, transparency on purpose).  iOS App Icon file untouched.  ASC tile updates on the next TestFlight.  Rollout: `docs/rollouts/2026-08-22-transparent-st-favicon-android.md`.
