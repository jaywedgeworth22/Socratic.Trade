...
> **2026-08-22 CURSOR — Alpaca Paper Approve greyed after Retry Red Team — COMPLETED / Deployed to production 2026-08-24 (PR #3049, squash `06a5418b`, live sha `dcfd04d7`).**  Paper is Exit-only.  Retry no longer greys Approve.  Retry applies the Red verdict.  Owner Approve of an opening in Exit-only is the override; the agent still will not open on its own.  Halted and liquidating still block openings.  Native iOS stale-gate + banner need TestFlight.  Rollout: `docs/rollouts/2026-08-22-alpaca-paper-approve-greyed.md`.
