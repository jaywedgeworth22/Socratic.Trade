...
> **2026-08-19 CURSOR — Robinhood quote chunk (`cursor/robinhood-quote-chunk-befc`).** Live `9d71dda4` died on `too many symbols (max 10, got 250)` 18s into gather.  Chunk Robinhood quote/tradability/fundamentals to 10.  Do not shrink the universe.  congress.trade 404 must not latch the free wave.  Do not reopen #2840 / #2848.  Do not touch #2850 / #2849 / #2841.  Do not merge / deploy / bounce.  Rollout: `docs/rollouts/2026-08-19-robinhood-quote-chunk.md`.
