...
> **2026-09-07 CLAUDE — Remove redundant postcss override (`claude/postcss-override-conflict`).**  Fixes the recurring Dependabot postcss failure ("Override ... conflicts with direct dependency", recurred 6x since 2026-08-24).  Override was not load-bearing (no transitive dep pinned an older postcss); removed it.  postcss now resolves to 8.5.28 tree-wide (was pinned to 8.5.15).  No scope/timeline change.  Rollout:  `docs/rollouts/2026-09-07-postcss-override-conflict.md`.
