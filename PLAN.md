...
> **2026-08-20 CURSOR — #2854 rebased onto main (`44e9ef06`).** CONFLICTING/DIRTY was phantom (`merge-tree` clean).  Kept gather inventory skip + 502/429 fail-open.  Did not absorb other clusters.  Do not merge.  Rollout: `docs/rollouts/2026-08-19-gather-no-pinecone-inventory.md`.
