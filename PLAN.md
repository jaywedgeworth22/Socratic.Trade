...
> **2026-08-25 CURSOR — AppUpdatePromptTests pbxproj leftover (`cursor/app-update-prompt-pbxproj-ddca`, PR #3103).**  #3102 squash `df75ca6f` omitted generated `AppUpdatePromptTests.swift` refs.  Commit the hosted `ios-build` artifact so TestFlight (no xcodegen) stays in sync.  Leftover `ios-build` `32809716228` 242/0.  Do not `--force-ship`.  Rollout: `docs/rollouts/2026-08-25-app-update-prompt-pbxproj.md`.
