...
> **2026-08-19 CURSOR — iOS Scan last-good on 503 (`cursor/ios-scan-last-good-503-b104`, #2850).** ASC: TF 1.0.68 `581467e1` already has #2830.  Live `/api/scan` still 503s without names (`4abfb7fa` path; live process `c55c2e64` #2848 did not change scan).  1.0.68 has no snapshot last-good and times out at 25s.  Seed-first `/api/scan` is what that binary can use.  Do not merge / deploy / bounce / second TestFlight.  Do not touch #2848/#2849/#2841/#2840.  Rollout: `docs/rollouts/2026-08-19-ios-scan-last-good-503.md`.
