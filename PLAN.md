...
> **2026-08-20 CURSOR-BUGBOT — Tradier open-order page walk (`cursor/tradier-open-orders-page-cap-bugbot`).** #2886 5-page default hid older GTC equity exits.  Walk 50 pages again; keep 24h terminal filter.  Rollout: `docs/rollouts/2026-08-20-tradier-open-orders-page-cap.md`.
