...
> **2026-08-26 CURSOR — CI autofix for #3091 (`cursor/ci-autofix-automation-27b6`).**  Publisher node:test no longer pins live `ios-app-versions.json`.  Constructed 2026-08-21 stale `--base-json` documents why remote seed is required.  Rollout: `docs/rollouts/2026-08-26-ios-versions-stale-fixture-test.md`.
