...
- Required handoff verification remains: `npx tsc --noEmit`, `npm test`, then
  `npm run build`. GitHub Actions CI is deferred until push credentials include
  the `workflow` scope needed to create `.github/workflows/*`.
