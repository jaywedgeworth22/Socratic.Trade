...
> **2026-08-25 CURSOR — AppUpdatePrompt Apple IDs off Swift (`cursor/app-update-prompt-apple-ids-ddca`).**  Keep ios-fleet pin/copy.  Drop `knownAppleIds`.  Live DealDex is `net.dealdex` 6802474288.  No Swift package / `testers.json` / `--force-ship` / spend.  Rollout: `docs/rollouts/2026-08-25-app-update-prompt-apple-ids.md`.
