...
> **2026-08-24 CURSOR — Hosted macos-latest TestFlight (`cursor/ios-hosted-testflight-ship-0e2b`).**  Do not run `xcodebuild` locally.  Do not restart `mac-xcode26-socratic`.  Vendor `scripts/ios-fleet/` like Congress.Trade, import ASC/P12 from GitHub Actions secrets (copy existing team credentials, do not mint), ship #3028 via `gh workflow run ios-ship.yml`.  Rollout: `docs/rollouts/2026-08-24-ios-hosted-testflight-ship.md`.
