...
> **2026-08-18 CURSOR — getAccounts loop budget (`cursor/getaccounts-loop-budget-befc`, #2848).** Same process `581467e1`: `gateway.getAccounts timed out after 6000ms — serving degraded snapshot` ×11; portfolio 8s / quotes 6s; alpaca-broker ok at 6570–6600ms after the abort.  Raise first wait to 16s including getEquityQuotes; bound FTS tick.  Do not merge / deploy / bounce.  Rollout: `docs/rollouts/2026-08-18-getaccounts-loop-budget.md`.
