...
> **2026-08-21 CURSOR — Light pill provider buttons (`cursor/login-light-provider-buttons`).**  Owner: the light Google button is the look; same treatment and monochrome marks for Google / GitHub / Apple.  No email/password.  Passkey not in this change.  Rollout: `docs/rollouts/2026-08-21-login-light-provider-buttons.md`.
