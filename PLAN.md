...
| 12 | Architecture Blueprint | `docs/architecture-blueprint.md` | Drafted 2026-06-20: target technical blueprint for tri-state execution, trailing stops, IRA taxation, multi-tenant RAG, and LLM reasoning. This is a design target, not completed runtime implementation. |
...
3. Phase 3 performance: snapshots, fills, mock/local vs live P&L, and run attribution.
