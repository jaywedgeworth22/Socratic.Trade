...
### Shared package (`@jaywedgeworth22/congress-trading-shared` **v2.5.0**)
...
2. **Parse dual legs** via shared client v2.5.0
...
### Files (ST)
- `package.json` / `package-lock.json` — pin shared `#v2.5.0`
