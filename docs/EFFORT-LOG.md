- **[Socratic.Trade][CURSOR] Pinecone trial end in 7 days — IN PROGRESS 2026-08-19 (branch `cursor/pinecone-trial-end-7d-c9a3`).** Owner: set the Standard-trial calendar to 7 days from 2026-08-19 (`2026-08-27T00:00:00.000Z`). App snap + Infisical `PINECONE_TRIAL_ENDS_AT`. Not changing Pinecone's own console trial. Not raising the daily WU fuse.
