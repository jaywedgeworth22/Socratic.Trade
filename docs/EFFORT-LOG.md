- **[Socratic.Trade][CURSOR] Purchases / Stripe / StoreKit end-to-end audit — IN PR 2026-08-17 (branch `cursor/purchases-stripe-storekit-audit-f1c0`).** Report only.  No Stripe/StoreKit stack on ST; invite-only allowlist.  App Review 3.1.1 PASS.  No implementation PR.  Audit: `docs/audits/2026-08-17-purchases-stripe-storekit.md`.
