...
- **[Socratic.Trade][CURSOR] rag-embed soft-degrade (no 503 / no autonomy halt) — IN PROGRESS 2026-08-18 (branch `cursor/rag-embed-soft-degrade-ed6d`).** One dead embed must not 503 Docker, restart, re-halt Green/Red, or park later batches.  Degrade `rag-embed`/`rag-rerank` like OpenRouter credits.  `pinecone` + `alpaca-broker` stay critical.  Did not steal #2792/#2798/#2800/#2794.
- **[Socratic.Trade][CURSOR] rag-embed soft-degrade (no 503 / no autonomy halt) — IN PR #2812 2026-08-18 (branch `cursor/rag-embed-soft-degrade-ed6d`).** One dead embed must not 503 Docker, restart, re-halt Green/Red, or park later batches.  Degrade `rag-embed`/`rag-rerank` like OpenRouter credits.  `pinecone` + `alpaca-broker` stay critical.  Did not steal #2792/#2798/#2800/#2794.
