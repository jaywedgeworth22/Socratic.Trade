- **[Socratic.Trade][CURSOR] Transparent ST favicon + future Android mark — IN PROGRESS 2026-08-22 (branch `cursor/st-transparent-favicon-android-4f1a`).**  Website favicon and `graphics/android/ic_launcher_foreground.png` stay RGBA.  Transparency is on purpose.  iOS `AppIcon-1024.png` not written.  ASC listing icon is the last processed build and needs TestFlight to replace the stale white centered ST.  Rollout: `docs/rollouts/2026-08-22-transparent-st-favicon-android.md`.
