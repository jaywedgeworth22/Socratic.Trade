- **[Socratic.Trade][CURSOR] Abort paid Finnhub wave on gather timeout — IN PR #3018 2026-08-21 (branch `cursor/gather-timeout-abort-0388`).**  Leftover after #3013 `eef81eb6`: first gather-abort dropped `AbortSignal` on paid/scarce waves so Finnhub's paced queue kept running after the 8m deadline.  Rematched onto `origin/main`.  Parent owns Coolify.  Rollout: `docs/rollouts/2026-08-21-gather-timeout-abort.md`.
