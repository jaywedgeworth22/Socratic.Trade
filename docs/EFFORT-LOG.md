- **[Socratic.Trade][CURSOR] Activity layout redesign — IN PR 2026-08-21 (PR #3031, branch `cursor/activity-layout-redesign-085b`, rematched onto `origin/main` `ffb4ea1b`).**  Website + iOS Activity: Alerts Center, Notifications, Strategy Runs, Order Fills, Audit Log (former All).  `ios-build` 233/0.  Fixing `verify` sentence-gap tooltip + AuditLogPanel wiring marker.  Rollout: `docs/rollouts/2026-08-21-activity-layout-redesign.md`.
