- **[Socratic.Trade][GROK] iOS Proposals For Review: proposed / live / target / delay + expert-panel target debate — IN PR #2740 2026-08-15 (branch `grok/ios-proposals-for-review`, worktree `~/apps/trading-grok-proposals-review`).**  Home metric under the count is Title Case "Proposals For Review".  Review cards show proposed price, live price, proposer target, and delay P&L.  Green/Red prompts debate a target and staged exits when none is set.  Optional `exitPlan` on the proposal.  Rollout: `docs/rollouts/2026-08-15-ios-proposals-for-review.md`.
