- **[Socratic.Trade][CURSOR] Abort abandoned strategy gather + last-good tape — IN PROGRESS 2026-08-21 (branch `cursor/gather-timeout-abort-0388`).**  Prod 2026-08-21 RTH: Roth + Paper every run `strategy gather timeout` after yesterday's 20:16/20:22Z completes.  Live `e0a4959a` already has #2852/#2854.  8m gather deadline was a pure race, so timed-out scans kept running and stacked.  Abort the controller, honor the signal in cascade/enrichment (including the paid Finnhub wave), reuse last completed MarketScan + 45s quote refresh so Green can start.  Do not HOTFIX during cash hours.  Rollout: `docs/rollouts/2026-08-21-gather-timeout-abort.md`.
