...
- **[Socratic.Trade][GROK] Provider-tier honesty (`dataProvidersDegraded`) — IN PROGRESS 2026-08-13 (branch `grok/st-provider-tier-honesty`, worktree `~/apps/trading-grok-provider-tier-honesty`, issue #2700).** Owner: do not flip degraded on a deliberate lower (still correct) plan.  Degrade only if the probe disagrees with the paid/configured tier or the provider is not working.  Massive `history_cap_blocked` on ~2.5y is expected on free.  New branch only; not touching #2687 #2689 #2691 #2692.  Rollout: `docs/rollouts/2026-08-13-provider-tier-honesty.md`.
