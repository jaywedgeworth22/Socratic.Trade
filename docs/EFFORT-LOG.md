...
## In Progress
- **Secure FMP Stable API Integration (AG, branch `agent/ag-fmp-transcripts`, worktree `/Users/jay/apps/trading-antigravity`) - IN PROGRESS 2026-07-15.** Integrating FMP stable endpoints (quotes, ETF sector weightings, macro, economics, calendars, transcripts, news, metrics, analyst ratings) with safe fetch routing, key scrubbing, and graceful 402 degradation.
