...
## In Progress
- **[Socratic.Trade][GROK] Dark mode near-black retint (branch `grok/dark-mode-near-black`) — IN PROGRESS 2026-07-22.** Public `.dark` + console dark tokens → `#0a0a0a` neutral charcoal; mesh opacity cut so login logo contrast is clean. Files: globals.css, console.css, layouts, global-error. Rollout: `docs/rollouts/2026-07-22-dark-mode-near-black.md`.
