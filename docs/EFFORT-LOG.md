...
- **[Socratic.Trade][GROK] UX Wave B IA (plain nav labels, Autonomy panel, Settings TOC) — IN PROGRESS 2026-08-04 (branch `grok/ux-wave-b-ia`). B1/B2/B4 implemented; B3 skipped; landing via land.sh.** Program §Wave B. Rollout: `docs/rollouts/2026-08-04-ux-wave-b-ia.md`.
