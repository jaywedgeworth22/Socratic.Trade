...
- **[Socratic.Trade][CURSOR] Gather must not inventory Pinecone or latch on congress 502 / Massive 429 — IN PROGRESS 2026-08-19 (branch `cursor/gather-no-pinecone-inventory-befc`).** Same `9d71dda4` window: thousands of Pinecone list/fetch, congress.trade 502, Massive 429.  No OpenRouter strategy/completion.  Only `usage_budget_status` at +10s then the crash.  Robinhood max-10 at +18s remains first hard fail (#2852 folded in).  Do not flip write-class.  Do not prune.  Do not reopen #2840.  Do not touch #2850 / #2849 / #2841.  Do not merge/deploy/bounce.  Rollout: `docs/rollouts/2026-08-19-gather-no-pinecone-inventory.md`.
- **[Socratic.Trade][CURSOR] Gather must not inventory Pinecone or latch on congress 502 / Massive 429 — IN PR #2854 2026-08-19 (branch `cursor/gather-no-pinecone-inventory-befc`).** Same `9d71dda4` window: thousands of Pinecone list/fetch, congress.trade 502, Massive 429.  No OpenRouter strategy/completion.  Only `usage_budget_status` at +10s then the crash.  Robinhood max-10 at +18s remains first hard fail (#2852 folded in).  Do not flip write-class.  Do not prune.  Do not reopen #2840.  Do not touch #2850 / #2849 / #2841.  Do not merge/deploy/bounce.  Rollout: `docs/rollouts/2026-08-19-gather-no-pinecone-inventory.md`.
