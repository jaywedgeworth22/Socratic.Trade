- **[Socratic.Trade][CURSOR] Sweep-failed orphan must not leave Manual Run once locked — IN PR #2847 2026-08-18 (branch `cursor/sweep-request-orphan-lock-befc`).** Live Roth `0e5ccd66` was sweep-failed at 22:13:05Z while `strategy_run_requests` stayed `running`; 5:14pm CT Run once 502'd with no new run row.  Close the matching request on sweep / `finishStrategyRun`; heal already-terminal mismatches.  Do not hide at queue time.  Do not merge/deploy.  Do not touch #2841.  Rollout: `docs/rollouts/2026-08-18-sweep-failed-request-lock.md`.
