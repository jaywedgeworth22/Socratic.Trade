...
- **2026-07-16 OpenRouter Migration Completed (AG, branch agent/aiplatform-auth-support-clean, PR pending).** Migrated all LLM calls to use OpenRouter to ensure proper control and cost reporting. Completed updates to the model catalog, rotation pool, reasoning recommendations, and test suites to support openrouter/ prefixes and reason-tier specific models (pro vs non-pro).
