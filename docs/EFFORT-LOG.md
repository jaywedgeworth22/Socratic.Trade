- **[Socratic.Trade][CURSOR] AppUpdatePromptTests pbxproj leftover after #3102 — IN PR 2026-08-25 (branch `cursor/app-update-prompt-pbxproj-ddca`).**  #3102 squash `df75ca6f` landed the pin/copy; hosted `ios-build` `32808123472` generated `AppUpdatePromptTests.swift` refs that the squash missed.  Commit the generated pbxproj + privacy-manifest assert so TestFlight (no xcodegen) stays in sync.  Do not `--force-ship`.  Do not dispatch `ios-ship.yml` unless the owner asks.  Rollout: `docs/rollouts/2026-08-25-app-update-prompt-pbxproj.md`.
