- **[Socratic.Trade][CURSOR] Indices common names on all surfaces — IN PROGRESS 2026-08-19 (branch `cursor/indices-common-names-3381`).** #2855 merged (`b27de85c`).  Live leak: Guardrails → Universe → Indices printed `sp500, nasdaqComposite, dow30, nyseComposite`.  Web selected-set + Scan chips + Desk + policy-diff use `formatIndexUniverseList` / `indexUniverseLabel` for every slug.  Do not merge/deploy/bounce/TF.  HOLD `5674dfaf`.  Do not touch #2841 / #2849 / #2854 / #2840.  Do not reopen #2855.  Rollout: `docs/rollouts/2026-08-19-indices-common-names.md`.
