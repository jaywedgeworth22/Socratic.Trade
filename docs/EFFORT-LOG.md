...
- **Activity-audit P2.5: notification status recorder lies ("Not sent" on 1035/1035 while 378 delivered) — COMPLETED 2026-07-11, AG.** Returned `NotifyChannelResult[]` from `sendDirectNotification`, deriving sent/failed/skipped honestly by aggregating channel outcomes. Report §1.5.
