- **[Socratic.Trade][CURSOR] Indices labels (`S&P 500`, not `sp500`) — IN PROGRESS 2026-08-19 (branch `cursor/indices-display-labels-3381`).** Copy/UI only.  iOS Guardrails and web policy-diff no longer print storage slugs.  `includedIndices` / `IndexUniverse` ids stay.  Do not merge/deploy/bounce/TF.  Do not touch #2841 / #2849 / #2854 / #2840 / #2850.  Rollout: `docs/rollouts/2026-08-19-indices-display-labels.md`.
