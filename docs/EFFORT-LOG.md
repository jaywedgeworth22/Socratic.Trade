...
- **[Socratic.Trade] UX Wave C perceived speed (snapshot TTL cache, P&L once, scan virtuoso, React.memo) — PARTIAL — PR-C3 IN PR #2415 (GROK); remaining C slices UNASSIGNED.** Program §Wave C. Hotspot: `src/lib/dashboard.ts`.
