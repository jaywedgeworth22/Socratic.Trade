...
- **[Socratic.Trade][GROK] UX PR-A1 honest run skip statuses in UI — IN PROGRESS 2026-08-04 (subagent, branch `grok/ux-a1-honest-skips`).** Budget/market/broker skips must not look like successful decision runs; distinct Activity/Thesis chips. Program: `docs/design/ux-improvement-program.md` §PR-A1. Money-adjacent status semantics.
