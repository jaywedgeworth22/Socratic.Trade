...
| 2026-07-29 | **Dual Max Drift Caps & Approval Price Delta UI** — Support distinct max entry drift caps for autonomous vs human review and display price delta + drift on approval cards. | ANTIGRAVITY | **Completed** | agent/antigravity/dual-drift-caps-and-price-delta-ui |
| Planned | Open Source Licensing | Add Apache 2.0 license to repository | Antigravity | 2026-07-29 |
