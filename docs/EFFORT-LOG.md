...
- **[Socratic.Trade][CURSOR] Account write guards (preserve Autopilot + block draining reactivate) — COMPLETED/MERGED 2026-08-20 #2876 `44e9ef06`.** Expert review tranche-1 `account-write-guards`.  Pin `strategyAuthority` on profile activate/copy/import; refuse draining activate; clear drain on reconnect upsert.  Rollout: `docs/rollouts/2026-08-19-account-write-guards.md`.
