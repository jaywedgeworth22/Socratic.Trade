...
## In Progress
- **[Socratic.Trade][CURSOR] Land leftover open PRs — IN PROGRESS 2026-08-21.**  #2990 rematched onto `origin/main`; neutralized gitleaks FP in the mobile-web handoff Playwright recipe (env names only, no inline values).
