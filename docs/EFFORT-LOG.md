...
- **[Socratic.Trade][GROK] UX B3+E2+E3 polish — IN PR 2026-08-04 (PR #2428, branch `grok/ux-b3-e-polish`, auto-merge armed).** Strategy progressive structure (Models·Instructions open; Scoring collapsed; Presets open); login 3 value bullets (iOS parity); CommandPaletteTrigger always on mobile (icon-only); healthy MobileFreshnessBar one-line. Gates: tsc clean, lint 0 errors, vitest 5886 passed / 51 skipped, build clean. Rollout: `docs/rollouts/2026-08-04-ux-b3-e-polish.md`. Program §PR-B3 / §PR-E2 / §PR-E3.
