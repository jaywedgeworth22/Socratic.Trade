...
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PROGRESS 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Roth/IRA tax card matches web N/A.  Push footer is “Alerts on.”  Ask-First ↔ Autopilot and raise/lower/% NAV caps on iOS with typed AUTOPILOT / live CONFIRM.  Did not steal reserved PRs.  `xcodebuild` unavailable on this VM.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PR #2825 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Roth/IRA tax card matches web N/A.  Push footer is “Alerts on.”  Ask-First ↔ Autopilot and raise/lower/% NAV caps on iOS with typed AUTOPILOT / live CONFIRM.  Did not steal reserved PRs.  lint + tsc + next build passed; `xcodebuild` unavailable on this VM.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PR #2825 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Live screenshot: hide taxable wash-sale guard/handling on Roth; never show `__rotate__`; no console-only cap rows.  Ask-First ↔ Autopilot and % NAV edits on iOS.  Same PR, no second branch.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PR #2825 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Live screenshot: hide taxable wash-sale guard/handling on Roth; show “Rotate models” instead of `__rotate__`; no console-only cap rows.  Ask-First ↔ Autopilot and % NAV edits on iOS.  Same PR, no second branch.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PR #2825 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Live screenshot: hide taxable wash-sale guard/handling on Roth; show “rotate models” instead of `__rotate__`; no console-only cap rows.  Ask-First ↔ Autopilot and % NAV edits on iOS.  Same PR, no second branch.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
- **[Socratic.Trade][CURSOR] iOS UX owner cut (IRA wash-sale N/A + ordinary copy + bidirectional caps) — IN PR #2825 2026-08-18 (branch `cursor/ios-ux-owner-cut-bdae`).** Live screenshot: hide taxable wash-sale guard/handling on Roth; show “rotate models” instead of `__rotate__`; sweep all user-facing iOS developer/API copy; no console-only cap rows.  Ask-First ↔ Autopilot and % NAV edits on iOS.  Same PR, no second branch.  Rollout: `docs/rollouts/2026-08-18-ios-ux-owner-cut.md`.
