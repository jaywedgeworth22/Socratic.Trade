...
## In Progress
- **[Socratic.Trade][CURSOR] iOS first-launch update prompt (fleet) — IN PROGRESS 2026-08-21 (branch `cursor/ios-update-prompt-9992`, worktree `~/apps/trading-cursor-ios-update`).**  On first open, ask to update when a newer version exists.  TestFlight opens TestFlight; App Store opens the App Store.  Manifest `jaywedgeworth22/ios-app-versions`.
