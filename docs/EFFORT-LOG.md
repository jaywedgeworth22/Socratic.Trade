- **[Socratic.Trade][CURSOR] Alert-noise leftover: retired FilingAPI + soft-limit ops + live boot pages — IN PROGRESS 2026-08-17 (branch `cursor/alert-noise-retired-boot-64c1`).** Owner 4:23–4:38pm CT burst. Live ST healthy after 21:35Z restart. Stamp retired vendors OFF; ops `ok` = hard-stop only; mute connection pages for 5 min on `DB_BOOTSTRAP=live`.
