...
## In Progress
- **[Socratic.Trade][CURSOR] rag-embed DeepInfra batch-window 400 — IN PROGRESS 2026-08-18 (branch `cursor/rag-embed-batch-window-54d7`).** Live VECTOR_EMBED_BATCH_SIZE=32 summed ~8193 tokens on OpenRouter baai/bge-m3 and 400'd ingest.  Pack embed POSTs under ~7500 approxTokens; isolate and chunk a single over-limit text.  Do not touch the #2812 health 503 gate.  Do not drop rag-embed from health.
