- **[Socratic.Trade][GROK] Congress overlay test fixture aged out of 60d window — IN PROGRESS 2026-08-15 (branch `grok/congress-window-fixture`, worktree `~/apps/trading-grok-congress-window`).** Blocking leftover #2689/#2691/#2719 verify.  Hardcoded `06/16/2026` eFD mock; `DEFAULT_WINDOW_DAYS=60`.  Relative dates.  Rollout: `docs/rollouts/2026-08-15-congress-window-fixture.md`.
