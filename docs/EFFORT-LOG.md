- **[Socratic.Trade][CURSOR] Light pill provider buttons + matching monochrome marks — IN PROGRESS 2026-08-21 (branch `cursor/login-light-provider-buttons`).**  Owner: light Google button look for all three; same style logos; no email/password; passkey deferred.  Web + iOS share one white/near-black capsule.  Rollout: `docs/rollouts/2026-08-21-login-light-provider-buttons.md`.
