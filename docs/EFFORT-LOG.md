- **[Socratic.Trade][CURSOR] Rename WrappingHStackTests.swift -> LayoutMathTests.swift + Mac CI xcodegen — IN PROGRESS 2026-08-21 (branch `cursor/ios-layout-math-tests-rename-3110`).**  Independent re-check of adaptive-tabs follow-ups: C/D/A-tests already on main (#3023/#3012, Mac 32529663287 232/0).  Item B was the leftover Linux-doable piece.  File renamed; `ios-build.yml` runs XcodeGen 2.46.0 then restores objectVersion 100.  pbxproj committed from the Mac artifact (no hand-edit).  Screenshots / auto-fill / knobs still open.  Rollout: `docs/rollouts/2026-08-21-ios-layout-math-tests-rename.md`.
...
- **[Socratic.Trade][CURSOR] iOS adaptive-tabs follow-ups leftovers after #3023 — IN PROGRESS 2026-08-21 (item B on `cursor/ios-layout-math-tests-rename-3110`).**  Item C VERIFIED (Mac job 32529663287 `success`, 232/0).  Item D CLOSED on main by #3012.  Item B rename in flight (LayoutMathTests.swift + Mac CI xcodegen).  Still open: (A) screenshots of iPad Air 11" / borrowed slot / Mac window drag; (E) owner keep-or-drop auto-fill; (F) tuning knobs.  Note: `docs/rollouts/2026-08-21-ios-adaptive-tabs-followups.md`.
