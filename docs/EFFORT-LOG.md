...
- **[Socratic.Trade][CURSOR] Finish ROIC Individual local archive — IN PR #2813 2026-08-20 (branch `cursor/roic-individual-archive-9ad4`).** Rebased onto `origin/main` `ce31c367` (#2798).  Skip cached ROIC list/fetch.  Persist `earningscalls_transcripts` + `data/roic-artifacts`.  Ops `roicArchive` + remaining-gap list.  Kept #2848 strategy-run pause.  Renew-vs-expire still open.  No Stripe.  Did not absorb other clusters.
