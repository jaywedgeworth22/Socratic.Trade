...
- **[Socratic.Trade][GROK] 13F + ARK daily holdings + Form 4 as live idea sources — IN PROGRESS 2026-08-15 (branch `grok/idea-sources-13f-ark-form4`, worktree `~/apps/trading-grok-idea-sources`, issue #2735).**  Official SEC 13F-HR, ARK fund CSVs, Form 4 persist + watchlist + strategy evidence.  Observe-only.
