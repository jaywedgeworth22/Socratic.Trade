- **[Socratic.Trade][BF-Fixer] PR #3120 Codex thread unstick — IN PROGRESS 2026-08-30 (PR #3120, branch `ag/st-auth-and-transcripts`, worktree `~/apps/trading-grok-pr-3120`, board fa5ac21d).**  Remaining REAL threads: fail-closed readiness/policy decode, cookie-salt reissue, earningscalls canonicalize, ops-snapshot rollout path.  No extra-ship.  No TestFlight.  Rollout: `docs/rollouts/2026-08-30-pr-3120-codex-threads.md`.
- **[Socratic.Trade][GROK] PR #3120 verify-hosted ops-snapshot trial pin — IN PROGRESS 2026-08-30 (PR #3120, branch `ag/st-auth-and-transcripts`, worktree `~/apps/trading-grok-pr-3120`, board fa5ac21d).**  `verify-hosted` failed `trial.active` expected true got false.  Merge `origin/main` (`f385fb03` / #3111) so the now+7d pin lands; keep auth/transcripts.  No squash-merge.  No extra-ship.  No `--force-ship`.  Rollout: `docs/rollouts/2026-08-30-pr-3120-ops-snapshot-pin.md`.
- **[Socratic.Trade][GROK] Surface asc-seq stderr + honest unverified die-text — COMPLETED (merged to `main`) 2026-08-30 (PR #3111, squash `f385fb037`).**  Correction GROK 2026-08-30: previously IN PROGRESS; GB-DEPLOYER squash-merged 1:02am CT.  CI-red was `ops-snapshot` `trial.active` after the 2026-08-27/08-30 pins expired; merged `origin/main` and pinned the fixture to now+7d.  iOS fleet intent unchanged.  No extra-ship.  No `--force-ship`.  Rollout: `docs/rollouts/2026-08-30-asc-seq-surface-stderr.md`.
