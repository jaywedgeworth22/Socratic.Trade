- **[Socratic.Trade][CURSOR] Remove redundant Home Desk subtitle — IN PR #2849 2026-08-19 (branch `cursor/remove-desk-subtitle-ba05`, SHA `ab118082`).** iOS Home `SectionHeading("Desk")` no longer lists Coach / Scan / Guardrails / Results above those same shortcut buttons.  Console has no matching chrome.  No replacement copy.  Buttons and tab routing unchanged.  Did not touch #2848 / #2847 / #2841 / #2840.  Do not merge/deploy.  Rollout: `docs/rollouts/2026-08-19-desk-subtitle-remove.md`.
