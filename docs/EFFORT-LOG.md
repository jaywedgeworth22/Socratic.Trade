- **[Socratic.Trade][GROK] Collapsed "You're set" card taller + vertical center — IN PROGRESS 2026-08-05 (branch `grok/youre-set-card-vertical-center`).** Collapsed collapsible card header was top-weighted (`pt-3.5 pb-1`); balanced padding + min-height when closed. Rollout: `docs/rollouts/2026-08-05-youre-set-card-vertical-center.md`.
