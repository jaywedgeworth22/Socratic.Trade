...
- **[Socratic.Trade][AG] Admin Server Stats & Settings cleanup — COMPLETED 2026-07-24.** Filtered out backup tasks from Coolify services in Server Stats, added Hetzner GitHub Action runners to Services list, added RAM used/free/total %, Disk Storage card (total/used/free/%), Host Uptime, and removed deprecated OPERATOR admin section from Console Settings.
