...
- **[Socratic.Trade][UNCLAIMED] iOS adaptive-tabs follow-ups leftovers after #3023 — PLANNED 2026-08-21.**  Item C VERIFIED (Mac job 32529663287 `success`, 232/0).  Item D CLOSED on main by #3012.  Still open: (A) screenshots of iPad Air 11" / borrowed slot / Mac window drag; (B) rename `WrappingHStackTests.swift` -> `LayoutMathTests.swift` (`xcodegen` on a Mac); (E) owner keep-or-drop auto-fill; (F) tuning knobs.  Note: `docs/rollouts/2026-08-21-ios-adaptive-tabs-followups.md`.
