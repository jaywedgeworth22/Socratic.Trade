- **[Socratic.Trade][CURSOR] Cross-app coordination audit (ST/CT/UM/CTS/DD/FLEET) — IN PROGRESS 2026-08-17 (branch `cursor/cross-app-coordination-audit-1212`).** Report only.  Pins match CTS `v2.5.2`; ST pin-check is a no-op vs vendor-era CT.  ST trades if CT/UM die; Coolify trio shares Hetzner; CT Senate needs the Mac.  Audit: `docs/audits/2026-08-17-cross-app-coordination.md`.
