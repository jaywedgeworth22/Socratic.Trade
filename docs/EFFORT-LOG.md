...
- **[Socratic.Trade][GROK] FMP/Quiver intentional OFF on Connections health + FMP policy defaults false — COMPLETED code 2026-08-05 (branch `grok/data-sources-overhaul`, pending land).** Admin health: FMP variants + Quiver muted OFF not red STOPPED; DEFAULT_POLICY fmp* false; Settings FMP card retired; keys POST rejects FMP. Rollout: `docs/rollouts/2026-08-05-fmp-quiver-health-off.md`.
