- **[Socratic.Trade][GROK] Review UX: approve speed + prices + Retry Red Team + agent controls + PWA off — IN PROGRESS 2026-08-16 (branch `grok/review-ux-parity`, worktree `~/apps/trading-grok-review-ux`).**  Full-universe scan removed from Approve.  Proposed/Now/Target/Delay on website and iOS.  Retry Red Team when critic failed.  State-aware Start/Stop.  `/mobile` redirects to `/console`.
- **[Socratic.Trade][GROK] iOS Proposals For Review: proposed / live / target / delay + expert-panel target debate — COMPLETED 2026-08-16 (merged #2740 `c1db7d12`).**  Home tile title is "Proposals for Review" above the count, nothing below.  Review cards show proposed price, live price, proposer target, and delay P&L.
