- **[Socratic.Trade][GROK] iOS full desk (Coach, Scan, Guardrails, Results, Data Sources) — IN PROGRESS 2026-08-13 (branch `grok/st-ios-full-desk`, worktree `~/apps/trading-grok-ios-full-desk`).** Owner: more native parity so the phone can be the full desk. New surfaces on existing session-cookie APIs (no steal of #2687/#2689/#2691/#2692). Light default, Title Case nav, two spaces after sentences.
