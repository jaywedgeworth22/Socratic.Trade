- **[Socratic.Trade][CURSOR-BUGBOT] Tradier open-order page walk — IN PROGRESS 2026-08-20 (branch `cursor/tradier-open-orders-page-cap-bugbot`).** #2886 5-page default hid GTC equity exits on page 6+; synthetic-stop could double-sell.  Restore 50-page walk; keep 24h terminal filter.  Rollout: `docs/rollouts/2026-08-20-tradier-open-orders-page-cap.md`.
