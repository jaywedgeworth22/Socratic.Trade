...
- **[Socratic.Trade][GROK] 13F + ARK + Form 4 idea sources — IN PROGRESS 2026-08-16 (branch `grok/ark-csv-fallback`, issue #2735).**  #2747 live: 13F 413 rows / 12/12 ISO periods.  ARK still 0 — document-table CF 403 skipped official CSV fallback.  Empty ARK now retries in 2m.
