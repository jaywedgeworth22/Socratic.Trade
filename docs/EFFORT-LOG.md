- **[Socratic.Trade][CURSOR] Review-debt leftovers: ios-fleet publish guard + vitest exclude + ios-ship beta gate — IN PROGRESS 2026-08-26 (branch `cursor/review-debt-leftovers`).**  Consolidates open #3091 (remote seed / refuse empty apps), #3095 (vitest exclude `scripts/**/*.test.mjs`), #3109 (stale fixture test).  `ios-ship.yml` also rejects beta in `xcodebuild -version` output.  Rollout: `docs/rollouts/2026-08-26-review-debt-leftovers.md`.
