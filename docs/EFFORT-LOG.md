- **[Socratic.Trade][CURSOR] CI autofix: ops-snapshot Pinecone trial pin — IN PROGRESS 2026-08-27 (branch `cursor/ci-autofix-ops-snapshot-trial`).**  `verify-hosted` failed `trial.active === true` after the default calendar `2026-08-27T00:00:00.000Z`.  Pin `PINECONE_TRIAL_ENDS_AT` in `test/ops-snapshot.test.ts`.  Not caused by #3110 iOS ship.  Rollout: `docs/rollouts/2026-08-27-ops-snapshot-trial-pin.md`.
