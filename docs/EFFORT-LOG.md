...
- **[Socratic.Trade][CURSOR] Alpaca Paper Approve greyed after Retry Red Team — COMPLETED (merged to `main`) + Deployed to production 2026-08-24 (PR #3049, squash `06a5418b`).**  Retry no longer greys Approve; retry applies Red verdict; owner Approve opens in Exit-only.  Live sha `dcfd04d7` contains fix.  Native iOS lane needs TestFlight for stale-gate UI.  Rollout: `docs/rollouts/2026-08-22-alpaca-paper-approve-greyed.md`.
