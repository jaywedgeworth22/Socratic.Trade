...
| 2026-07-09 | Socratic.Trade | UI | Turn static LoadingBrand into a fast, pulsing candlestick animation | Completed | ag/loading-animation | Exposed speedMs on HeaderLogo and applied animate-pulse to LoadingBrand. |
