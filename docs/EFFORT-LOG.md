- **[Socratic.Trade][CURSOR] Manual Run once must not wait behind ROIC/FTS — IN PR #2848 2026-08-18 (branch `cursor/getaccounts-loop-budget-befc`).** VERIFY_FAIL: `test/alpaca-mcp.test.ts:214` hung 60s — test advanced 5s after `readAccount` first wait became 16s.  Advance `ALPACA_ACCOUNT_READ_FIRST_MS`.  Live-path ROIC/FTS pause kept.  Do not skip the test.  Do not merge/deploy.  Rollout: `docs/rollouts/2026-08-18-getaccounts-loop-budget.md`.
