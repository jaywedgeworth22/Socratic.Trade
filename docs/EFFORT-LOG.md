- **[Socratic.Trade][GROK] UX PR-A2 approval card progressive disclosure + sticky mobile CTAs — IN PROGRESS 2026-08-04 (branch `grok/ux-a2-approval-density`).** Default collapsed receipt (side/symbol/size, Live/Paper, AI-critic chip, 2–3 line thesis); expand for full sizing/R:R/RAG/policy/models/three-outcomes; sticky Approve/Reject above `.con-tabbar` + safe-area on mobile. Approve API + live typed confirm unchanged. Rollout: `docs/rollouts/2026-08-04-ux-a2-approval-density.md`. Program §PR-A2.
