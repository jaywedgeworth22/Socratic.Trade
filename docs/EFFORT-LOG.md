...
- **[Socratic.Trade][CURSOR] Green 400 must actually fail over — IN PR #2831 2026-08-18 (branch `cursor/green-400-failover-terra-2639`).** Rebased onto `origin/main` `12e8dcd` (#2812 kept; sole conflict `docs/phase-7-strategy.md`).  First Green after #2829: Paper terra HTTP 400, one stored call, "3 endpoints exhausted", Red never ran.  400 is failover-eligible; exhausted suffix uses stored attempts; terra is not first pick when Gemini Flash / Mistral Medium seats remain.  Did not revert #2812/#2829/#2800.  Rollout: `docs/rollouts/2026-08-18-green-400-failover.md`.
