- **[Socratic.Trade][GROK] Collapse model versions onto family identity for results/benchmarks/history — IN PROGRESS 2026-08-15 (branch `grok/model-family-identity`, issue #2724).**  `gemini-3.7-flash` → `gemini-flash-latest`; same for Flash Lite / Pro / Opus / Sonnet / etc.  Red stamps the family id; Results and critic stats read through `canonicalModelId`.
