- **[Socratic.Trade][GROK] iOS login brand parity (candlestick wordmark) — IN PROGRESS 2026-08-07 (branch `grok/ios-login-brand`).** Match website login: `CandleWordmarkView` port of `candle-ticker.ts`, accent-dot bullets, plain bg, Google accent / GitHub outline / Apple SIWA order. `xcodebuild` green. Rollout: `docs/rollouts/2026-08-07-ios-login-brand.md`.
