...
## In Progress
- **[2026-07-30][GROK] Share App A price-needs for congressional S&P performance — IN PROGRESS.** `fromAppANeeds` + nightly needs merge + deep history. Branch: `grok/share-price-needs`.
