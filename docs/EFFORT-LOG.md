...
- **[Socratic.Trade][GROK] iOS adaptive-tabs item A screenshots (iPad Air 11 + Mac window) — PLANNED 2026-08-21 (local Mac; Cursor local is down).**  Brief: `docs/rollouts/2026-08-21-ios-adaptive-tabs-mac-qa.md`.  Do not redo B/C/D.  Do not touch E/F unless shots prove it.  Babysit #3027 `verify` if still open.
