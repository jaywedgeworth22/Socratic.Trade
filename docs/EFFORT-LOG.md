- **[Socratic.Trade][CURSOR] Manual Run once drain must resume a claimed worker — IN PROGRESS 2026-08-19 (branch `cursor/manual-run-drain-handoff-befc`).** #2848 live (`c55c2e64`).  Roth `9d71dda4` llm=0 then sweep-failed 01:29:44Z `stalled_no_progress` (~31m).  ASC embed already skipped.  Cause: HTTP kick claimed `queued`→`running`, drain selected only `queued` (1372 skipped).  Heartbeat + same-id resume + `after()` + 8m gather deadline + bound pre-Green Alpaca snapshot.  Quote-chunk is #2852.  Do not only add another skip.  Do not merge/deploy.  Rollout: `docs/rollouts/2026-08-19-manual-run-drain-handoff.md`.
- **[Socratic.Trade][CURSOR] Manual Run once must not wait behind ROIC/FTS — COMPLETED/MERGED 2026-08-18 #2848 `c55c2e64`.** Live Roth wrote `9d71dda4` then sat llm=0; follow-up is drain handoff (`cursor/manual-run-drain-handoff-befc`).  VERIFY_FAIL on the PR (`test/alpaca-mcp.test.ts:214`) was fixed before merge.
- **[Socratic.Trade][CURSOR] Robinhood max-10 quote chunk for 250-name gather — IN PROGRESS 2026-08-19 (branch `cursor/robinhood-quote-chunk-befc`).** Roth `9d71dda4` llm=0 then `stalled_no_progress` 01:29:44Z.  Live error: `too many symbols (max 10, got 250)` at 00:59:15Z.  Chunk `get_equity_quotes` / tradability / fundamentals to 10.  congress.trade 404 must not latch gather.  Do not shrink the universe.  Do not reopen #2840 / #2848.  Do not touch #2850 / #2849 / #2841.  Do not merge/deploy.  Rollout: `docs/rollouts/2026-08-19-robinhood-quote-chunk.md`.
- **[Socratic.Trade][CURSOR] Robinhood max-10 quote chunk for 250-name gather — IN PR #2852 2026-08-19 (branch `cursor/robinhood-quote-chunk-befc`, SHA `7fa03750`).** Roth `9d71dda4` llm=0 then `stalled_no_progress` 01:29:44Z.  Live error: `too many symbols (max 10, got 250)` at 00:59:15Z.  Chunk `get_equity_quotes` / tradability / fundamentals to 10.  congress.trade 404 must not latch gather.  Do not shrink the universe.  Do not reopen #2840 / #2848.  Do not touch #2850 / #2849 / #2841.  Do not merge/deploy.  Rollout: `docs/rollouts/2026-08-19-robinhood-quote-chunk.md`.
