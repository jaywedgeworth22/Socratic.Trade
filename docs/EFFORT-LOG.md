- **[Socratic.Trade][GROK] Ungate congress share + 8-K full body + CSP report-only + UM read token + Apple web — IN PROGRESS 2026-08-13 (branch `grok/st-ungate-share-8k-apple-csp`, worktree `~/apps/trading-grok-ungate`).** Owner: turn these ON and functioning.  Leave `VECTOR_ASOF_STRICT` off; leave FMP transcript rights off.  Do not touch #2687/#2689/#2691/#2692.
