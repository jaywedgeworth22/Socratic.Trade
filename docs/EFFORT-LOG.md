...
- **[Socratic.Trade][GROK] 13F + ARK + Form 4 idea sources — IN PROGRESS 2026-08-16 (branch `grok/idea-sources-ops-fix`, worktree `~/apps/trading-grok-idea-sources-ops`, issue #2735).**  #2736 is live but not fully operational: Form 4 537 rows, 13F 210/7 filers with accession-CIK periods, ARK 0 locked by empty fetchedAt.  Fixing EDGAR MM-DD-YYYY + namespaced infoTable + unnamed XML + empty-TTL retry.
- **[Socratic.Trade][GROK] iOS Proposals For Review: proposed / live / target / delay + expert-panel target debate — IN PR #2740 2026-08-16 (branch `grok/ios-proposals-for-review`, worktree `~/apps/trading-grok-proposals-review`).**  Home tile title is "Proposals for Review" above the count, nothing below.  Review cards show proposed price, live price, proposer target, and delay P&L.  Green/Red prompts debate a target and staged exits when none is set (`agentic-strategy@2.10.0`).  Merged origin/main (#2743) and re-arming.  Rollout: `docs/rollouts/2026-08-15-ios-proposals-for-review.md`.
- **[Socratic.Trade][GROK] iOS Proposals For Review: proposed / live / target / delay + expert-panel target debate — COMPLETED/DEPLOYED 2026-08-16 #2740 `c1db7d12`.**  Home tile title is "Proposals for Review" above the count, nothing below.  Review cards show proposed, now, target, delay P&L.  Prompt `agentic-strategy@2.10.0`.  Native TestFlight still shipping.  Rollout: `docs/rollouts/2026-08-15-ios-proposals-for-review.md`.
