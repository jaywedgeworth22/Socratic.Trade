...
- **[Socratic.Trade][CURSOR] iOS Scan empty table is a quote miss — IN PR #2830 2026-08-18 (branch `cursor/scan-empty-screener-a128`, rebased onto `6429d984`).** Coolify `d0359642` 505/0/0 abort written as `market_scan`; last good `2f2a8e11`.  `BROWSER_UA` + `fetchWithRetry`; Yahoo whole-set; 503 + `market_scan_failed`; iOS shows 503 warnings + counts, no Guardrails blame.  Not #2829.  Rollout: `docs/rollouts/2026-08-18-scan-empty-screener.md`.
