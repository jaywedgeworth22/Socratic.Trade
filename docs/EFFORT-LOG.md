- **[Socratic.Trade][CURSOR] Manual Run once must not wait behind ROIC/FTS — IN PR #2848 2026-08-18 (branch `cursor/getaccounts-loop-budget-befc`).** Rebased onto `4abfb7fa`.  Roth `b3b83913` llm=0 ~17m; ROIC in-flight since 23:11:45Z; 78 FTS slices 6–13s.  16s wait + FTS 2s/1-row kept; pause ROIC/FTS while a run is queued/running.  Do not reopen #2840.  Do not merge/deploy.  Do not touch #2841/#2812.  Rollout: `docs/rollouts/2026-08-18-getaccounts-loop-budget.md`.
