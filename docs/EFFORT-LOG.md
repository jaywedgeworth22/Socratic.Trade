...
## In Progress
- **[Socratic.Trade][CURSOR] Alert repeat lock — IN PROGRESS 2026-08-20 (cluster `alert-repeat-lock`, branch `cursor/alert-repeat-lock-2b9b`).** 60s same-fingerprint delivery lock.  Rollout: `docs/rollouts/2026-08-20-alert-repeat-lock.md`.
