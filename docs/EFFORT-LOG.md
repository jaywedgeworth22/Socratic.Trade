...
- **Mistral benchmark data in the model-picker UI (MONET, session worktree
  ...
  2026-07-10: merged to `main` as PR #1361 and auto-deployed to production (state
  correction 2026-07-11 — the row was left at IN PROGRESS when the PR merged).**
  Research found the app already has two
