- **[Socratic.Trade][GROK] Retire direct FMP / QuiverQuant / Unusual Whales — IN PROGRESS 2026-08-04 (branch `grok/no-direct-fmp-quiver-uw`).** Owner: ST must not call FMP/Quiver/UW; consume via Congress.Trade. Hard ban at `requestFmp`, registration, Quiver resolve, tier probe, transcript request, fmp-hoard script. App A fundamentals + congress-source + analytics default ON. Rollout: `docs/rollouts/2026-08-04-retire-direct-fmp-quiver-uw.md`.
