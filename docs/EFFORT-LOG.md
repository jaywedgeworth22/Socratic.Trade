...
## In Progress
- **[Socratic.Trade][CODEX team] RAG strategic-performance implementation program (claimed 2026-07-21) — IN PROGRESS / RETRIEVAL INTEGRATED LOCALLY 2026-07-22.** Provider-aware ingestion, production-path PIT evaluation, committed/current FTS5 recall, dense+lexical RRF, independently routed/default-off adaptive reranking, and text-free stage telemetry are implemented. Integration-focused verification passes 5 files / 45 tests and scoped lint with zero errors. Prompt-consumption receipts, structured/narrative routing, parent expansion, shadow provider harnesses, current-main reconciliation, and the ordered full gate remain. Production corpus re-embed remains externally owned; no competing corpus write or legacy purge. Integration worktree: `/Users/jay/.codex/worktrees/rag-retrieval-integration-20260722`, branch `codex/rag-retrieval-integration-20260722`.
