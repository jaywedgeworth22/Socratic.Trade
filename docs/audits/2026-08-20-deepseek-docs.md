...
- grep for stale IPs/UUIDs: <ORACLE_IP_RETIRED>, 135.181.192.190, 77.42.35.209, m1os7ijf31bg3fanil152e4b, jays.services/api/v1, host.jays.services (live docs only)
