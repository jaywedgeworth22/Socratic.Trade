...
Branch `cursor/rag-embed-batch-window-54d7`.  PR **#2840**.  Rematched onto `origin/main` `581467e1` (#2831 Green 400 + #2830 scan).  Sole real conflict was `docs/phase-7-strategy.md` — kept both this batch-window stanza and main's Green 400 stanza.  Runtime unchanged.  Rollout: `docs/rollouts/2026-08-18-rag-embed-batch-window.md`.  Linux VM: no xcodebuild.
