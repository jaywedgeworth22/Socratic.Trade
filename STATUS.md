...
## 2026-07-21 — Native iOS mobile-first Phase 1 ready for review (CODEX, branch `codex/mobile-first-ios-20260721`)
...
fixes. Release signing remains enabled and automatic for team
...
with `trade.socratic.app` and has 3/3 focused tests; no trading or unrelated web path changed.
Changes are ready for commit/PR. Rollout:
