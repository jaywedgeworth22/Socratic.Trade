## 2026-07-29 — Proposals & Lessons Tab Split (AG) — DONE

Combined the separate Trade Proposals and Lessons pages into a single tabbed UI under `/console/approvals`. Re-used the tab switcher pattern from the Activity Journal. Removed the standalone "Lessons" destination from the navigation menu. Rollout: `docs/rollouts/2026-07-29-split-proposals-tab.md`.
