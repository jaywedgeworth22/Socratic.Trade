...
- 2026-06-22 (`feat/seo-landing-prep`): **Launch prep — SEO foundation (noindex by default) + flag-gated
  ...
  `PUBLIC_PREFIXES`; env in `.env.example`. Positioning decision (from the 2026-06-22 deep-research run):
  market as research/paper/education, not "AI trades your money". Code built by a Sonnet subagent. No
  public demo (needs an unauthenticated sandboxed surface — deferred). tsc clean, 804 tests, build green.
