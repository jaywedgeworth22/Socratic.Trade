...
FMP_API_KEY=...
FMP_MAX_SYMBOLS=15               # absolute enrichment-budget override (free-tier quota friendly); unset, providers enrich the scan's full candidate set (ranked + outliers + held), capped at 50
