...
// Label + recommendation conventions (owner rulings 2026-07-08 + 2026-07-09):
...
// - Recommendation flags: the CANONICAL policy, evidence, and full rationale live in the
//   conventions block atop app/ui/llm-model-catalog.ts — read it before changing any flag here,
//   and keep the two copies' flags/labels byte-consistent (modulo this file's "· $$" tier
//   suffix). Summary of the 2026-07-09 re-derivation: a rec chip is earned by SUBSTANTIVE
//   benchmark output for that role (real proposals with brackets / inspectable review work — not
//   mere schema-validity), weighed with realized history where it exists and role-appropriate
//   reasoning depth (the Red seat is the adversarial gate on real-money trades). Current flags:
//   GREEN = claude-haiku-4-5 + gemini-3.5-flash; RED = gemini-3.1-pro-preview (owner ruling
//   2026-07-09) + claude-sonnet-5. Removed 2026-07-09: deepseek-v4-pro Red (its 17/3 bear record
//   is parse-level silent-veto inflation — benchmark showed 0% Red schema validity), gpt-5.4-mini
//   Green+Red (observed reasoning burnout + unverifiable all-veto; records incumbent-circular),
//   gemini-3.5-flash Red (crowded out by sonnet's inspectable review work; provider
//   concentration). Key-level quota/rate limits (e.g. the 2026-07 Anthropic usage cap, OpenAI
//   RPM=2 429s) are OWNER-ADJUSTABLE account settings, NOT model qualities — never hold them
//   against a model here. Re-derive flags as attributed rotation history accrues.
const MODEL_GROUPS: ModelGroup[] = [
  {
    ...
    options: [
      ...
      { value: "gpt-5.4-mini", label: "gpt-5.4-mini — balanced OpenAI mini · $$" },
  ...
  },
  {
    ...
    options: [
      { value: "claude-haiku-4-5", label: "claude-haiku-4-5 — fast low-cost Claude · $", recommendedGreen: true },
