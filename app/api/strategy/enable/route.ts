...
export async function POST(request: Request) {
  ...
  if (policy.includedIndices.length === 0 && policy.additionalSymbols.length === 0) return new NextResponse("Configure an allowlist before enabling autonomy.", { status: 400 });
