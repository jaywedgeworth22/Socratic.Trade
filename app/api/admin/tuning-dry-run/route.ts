...
//
// Gated: requireAdmin (runs only outside production OR when ADMIN_REINDEX_TOKEN matches the x-admin-token
// header). This mirrors the backtest-ic "suggestion only" pattern — it never mutates policy.
