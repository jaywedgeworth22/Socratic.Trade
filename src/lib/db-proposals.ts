/**
 * db-proposals.ts — Trade proposal CRUD operations.
 * Extracted from db.ts. All DB access goes through getDb() from "./db".
 */

import { getDb, scopeAccount } from "./db";
import type { TradeProposal, PolicyDecision, PendingProposal, ReviewedOrder } from "./types";
