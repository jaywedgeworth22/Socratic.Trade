/**
 * db-api-keys.ts — Field-level encryption, API key storage, connected accounts,
 * synthetic trailing stops, user watchlist, price alerts, notification prefs,
 * chat turns, and memory.
