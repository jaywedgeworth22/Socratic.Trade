...
- 'executionMode': mock/local is the app's local simulator; broker/paper is a broker-hosted sandbox such as Alpaca Paper; broker/live is a production broker account.
